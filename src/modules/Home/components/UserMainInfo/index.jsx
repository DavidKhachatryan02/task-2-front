    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <div className={styles.mainContainer}>
        ...
        <div className={styles.secondRow}>
          <TextField disabled label="Email" variant="standard" value={email} />
          <TextField
            disabled
        ...
        <div className={styles.thirdRow}>
          <DatePicker disabled label="Start Date" value={formatedStartDate} />
          <TextField
            disabled
          ...
          <FormControlLabel
            disabled
            control={<Checkbox checked={isCoreTeamMember} />}
